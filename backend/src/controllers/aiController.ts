...
export class AIController {
  ...
  async analyzeTicket(req: Request, res: Response) {
    try {
      ...
      const analysis = await aiService.analyzeTicketPriority(
        title,
        description,
        category,
        parseInt(providerId)
   ...
   */
  async predictFailures(req: Request, res: Response) {
    try {
      ...
      const predictions = await aiService.predictEquipmentFailures(parseInt(providerId));
  ...
  async getInsights(req: Request, res: Response) {
    try {
      ...
      const [failurePredictions] = await Promise.all([
        aiService.predictEquipmentFailures(parseInt(providerId))
      ]);
   ...
   */
  async trainMLModel(req: Request, res: Response) {
    try {
      const { providerId } = req.params;
   ...
   */
  async classifyTicket(req: Request, res: Response) {
    try {
   ...
   */
  async analyzeHistoricalPatterns(req: Request, res: Response) {
    try {
      const { providerId } = req.params;
   ...
   */
  async analyzeEquipmentHealth(req: Request, res: Response) {
    try {
      const { providerId } = req.params;
   ...
   */
  async predictEquipmentFailure(req: Request, res: Response) {
    try {
   ...
   */
  async generateMaintenanceSchedule(req: Request, res: Response) {
    try {
      const { providerId } = req.params;
   ...
   */
  async findAutomaticSolution(req: Request, res: Response) {
    try {
   ...
   */
  async generateProactiveSuggestions(req: Request, res: Response) {
    try {
      const { providerId } = req.params;
   ...
   */
  private generateRecommendations(predictions: any[]) {
   ...
   */
  private generateAlerts(predictions: any[]) {
    const alerts = [];

    // Alertas de falha iminente (próximos 7 dias)
    const imminentFailures = predictions.filter(p => 
