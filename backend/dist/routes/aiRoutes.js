 ...
 */
router.post('/analyze-ticket', aiController_1.aiController.analyzeTicket.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get('/predict-failures/:providerId', aiController_1.aiController.predictFailures.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get('/insights/:providerId', aiController_1.aiController.getInsights.bind(aiController_1.aiController));
 ...
 *         description: Erro interno do servidor
 */
router.post('/ml/train/:providerId', aiController_1.aiController.trainMLModel.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.post('/ml/classify-ticket', aiController_1.aiController.classifyTicket.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get('/ml/historical-patterns/:providerId', aiController_1.aiController.analyzeHistoricalPatterns.bind(aiController_1.aiController));
 ...
 *         description: Erro interno do servidor
 */
router.get('/equipment/health/:providerId', aiController_1.aiController.analyzeEquipmentHealth.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get('/equipment/predict-failure/:equipmentId', aiController_1.aiController.predictEquipmentFailure.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get('/equipment/maintenance-schedule/:providerId', aiController_1.aiController.generateMaintenanceSchedule.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get('/equipment/detect-anomalies/:providerId', aiController_1.aiController.detectAnomalies.bind(aiController_1.aiController));
 ...
 *         description: Erro interno do servidor
 */
router.post('/chat/start', aiController_1.aiController.startChatSession.bind(aiController_1.aiController));
/**
 * @swagger
 * /api/ai/chat/message:
 *   post:
 ...
 *         description: Erro interno do servidor
 */
router.post('/chat/message', aiController_1.aiController.processChatMessage.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.post('/chat/find-solution', aiController_1.aiController.findAutomaticSolution.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.get('/chat/suggestions/:providerId', aiController_1.aiController.generateProactiveSuggestions.bind(aiController_1.aiController));
/**
 * @swagger
 ...
 *         description: Erro interno do servidor
 */
router.post('/chat/end/:sessionId', aiController_1.aiController.endChatSession.bind(aiController_1.aiController));
