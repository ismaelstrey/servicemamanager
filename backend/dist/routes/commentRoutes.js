 ...
 */
router.post('/', rateLimitMiddleware_1.createResourceRateLimit, (0, auditMiddleware_1.auditMiddleware)('comments'), commentController.createComment.bind(commentController));
/**
 * @swagger
 * /api/comments:
 *   get:
 ...
 *                       type: integer
 */
router.get('/', (0, cacheMiddleware_1.listCacheMiddleware)(), commentController.getComments.bind(commentController));
/**
 * @swagger
 * /api/comments/recent:
 *   get:
 ...
 *                     $ref: '#/components/schemas/Comment'
 */
router.get('/recent', (0, cacheMiddleware_1.cacheMiddleware)({ ttl: 300, keyPrefix: 'comments:recent' }), commentController.getRecentComments.bind(commentController));
/**
 * @swagger
 ...
 *                     $ref: '#/components/schemas/Comment'
 */
router.get('/:resourceType/:resourceId', (0, cacheMiddleware_1.cacheMiddleware)({ ttl: 600, keyPrefix: 'comments:resource', varyBy: ['resourceType', 'resourceId'] }), commentController.getCommentsByResource.bind(commentController));
/**
 * @swagger
 ...
 */
router.get('/:id', (0, cacheMiddleware_1.cacheMiddleware)({ ttl: 1800, keyPrefix: 'comments:detail', varyBy: ['id'] }), commentController.getCommentById.bind(commentController));
/**
 * @swagger
 * /api/comments/{id}:
 *   put:
 ...
 *         description: Comentário não encontrado
 */
router.put('/:id', (0, auditMiddleware_1.auditMiddleware)('comments'), commentController.updateComment.bind(commentController));
/**
 * @swagger
 * /api/comments/{id}:
 *   delete:
 ...
 *         description: Comentário não encontrado
 */
router.delete('/:id', (0, auditMiddleware_1.auditMiddleware)('comments'), commentController.deleteComment.bind(commentController));
